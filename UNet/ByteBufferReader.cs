...
namespace UNet
{
	...
	public static class ByteBufferReader
	{
		...
		public static bool ReadBool(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static char ReadChar(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static sbyte ReadSByte(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static short ReadInt16(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static ushort ReadUInt16(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static int ReadInt32(in byte[] buffer, int index)
		{
			int value = 0;
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static uint ReadUInt32(in byte[] buffer, int index)
		{
			uint value = 0;
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static long ReadInt64(in byte[] buffer, int index)
		{
			long value = 0;
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static ulong ReadUInt64(in byte[] buffer, int index)
		{
			ulong value = 0;
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static float ReadSingle(in byte[] buffer, [ReadOnly(true)] int index)
		{
			int value = ReadInt32(buffer, index);

			if(value == 0 || value == int.MinValue) return 0f;
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static float ReadHalf(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static DateTime ReadDateTime(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static TimeSpan ReadTimeSpan(in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static decimal ReadDecimal(in byte[] buffer, int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Guid ReadGuid(in byte[] buffer, [ReadOnly(true)] int index)
		{
			byte[] guidBuffer = new byte[16];
			Array.Copy(guidBuffer, index, guidBuffer, 0, 16);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static uint ReadVarUInt32(in byte[] buffer, int index)
		{
			uint value = 0;
			uint part;
			int bits = 0;
		...
		/// </summary>
		public static int GetVarUInt32Size(in byte[] buffer, [ReadOnly(true)] int index)
		{
			int i = 0;
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Vector2 ReadVector2(in byte[] buffer, int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Vector3 ReadVector3(in byte[] buffer, int index)
		{
			float x = ReadSingle(buffer, index);
			index += 4;
			float y = ReadSingle(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Vector4 ReadVector4(in byte[] buffer, int index)
		{
			float x = ReadSingle(buffer, index);
			index += 4;
			float y = ReadSingle(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Quaternion ReadQuaternion(in byte[] buffer, int index)
		{
			float x = ReadSingle(buffer, index);
			index += 4;
			float y = ReadSingle(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Vector2 ReadHalfVector2(in byte[] buffer, int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Vector3 ReadHalfVector3(in byte[] buffer, int index)
		{
			float x = ReadHalf(buffer, index);
			index += 2;
			float y = ReadHalf(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Vector4 ReadHalfVector4(in byte[] buffer, int index)
		{
			float x = ReadHalf(buffer, index);
			index += 2;
			float y = ReadHalf(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static Quaternion ReadHalfQuaternion(in byte[] buffer, int index)
		{
			float x = ReadHalf(buffer, index);
			index += 2;
			float y = ReadHalf(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static string ReadVarASCIIString(in byte[] buffer, int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static string ReadASCIIString(int bytesCount, in byte[] buffer, [ReadOnly(true)] int index)
		{
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static string ReadVarUTF8String(in byte[] buffer, int index)
		{
			uint length = ReadVarUInt32(buffer, index);
			index += GetVarUInt32Size(buffer, index);
		...
		/// <param name="buffer">Target buffer</param>
		/// <param name="index">Index in the buffer where to start reading data</param>
		public static string ReadUTF8String(int bytesCount, in byte[] buffer, int index)
		{
			string str = "";
			int character = 0;
			int charCounter = 0;
